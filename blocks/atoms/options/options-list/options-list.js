...
s * @property {string} optionValue - The value for the option (required).
 ...
 * @param {(optionValue: string) => void} setSelectedOption - Callback to set the selected option.
 ...
 */
export default function createOptionsList(optionsArray, setSelectedOption, instrumentation = {}) {
  ...
  optionsArray.forEach((optionConfig) => {
    ...
    option.onclick = () => {
      setSelectedOption(optionConfig.optionValue);
    };
