...
import { lockBodyScroll, unlockBodyScroll } from "../../../scripts/utils";
import {
  BUTTON_ICON_SIZES,
  BUTTON_VARIANTS
} from "../../atoms/buttons/standard-button/standard-button";
import createOverlay from "../../atoms/overlay/overlay";
...
const closeDialog = (block, panel, overlay) => {
  ...
  const wrapper =
    block.closest(".dialog-container") ||
 ...
 * @param {string} dialogText The dialog text
